...
tf.app.flags.DEFINE_string('cost', fuse_cnn_petct.CROSS_ENTROPY,
                            'Cost function')
tf.app.flags.DEFINE_float('loss_params', None,
                            'Cost function parameters')
tf.app.flags.DEFINE_string('output_style', fuse_cnn_petct.STYLE_DEFAULT,
                            'output style')
...
def main(_):
    ...
    hps = fuse_cnn_petct.HParams(batch_size=batch_size,
    ...
    design = fuse_cnn_petct.DParams(width = 256, height = 256, depth = 1, num_mods = 2, num_filters = 64, conv_kern = [3,3],
