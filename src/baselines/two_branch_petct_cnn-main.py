...
tf.app.flags.DEFINE_string('cost', two_branch_petct_cnn.CROSS_ENTROPY,
                            'Cost function')
tf.app.flags.DEFINE_float('loss_params', None,
                            'Cost function parameters')
tf.app.flags.DEFINE_string('output_style', two_branch_petct_cnn.STYLE_DEFAULT,
                            'output style')
...
def get_metrics_ops(model, mode='train'):
    ...
    if FLAGS.output_style == two_branch_petct_cnn.STYLE_SPLIT:
    ...
    elif FLAGS.output_style == two_branch_petct_cnn.STYLE_SINGLE:
...
def train(hps, design):
    ...
    model = two_branch_petct_cnn.TwoBranchFuseNet(hps, design, ct, pt, ctlb, ptlb, bglb, FLAGS.mode) 
...
def main(_):
    ...
    hps = two_branch_petct_cnn.HParams(batch_size=batch_size,
    ...
    design = two_branch_petct_cnn.DParams(width = 256, height = 256, depth = 1, num_mods = 2, num_filters = 64, conv_kern = [3,3],
